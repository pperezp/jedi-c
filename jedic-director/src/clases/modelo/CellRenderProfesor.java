 ...
 */
public class CellRenderProfesor implements javax.swing.ListCellRenderer{
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        label.setIcon(new ImageIcon(this.getClass().getResource("/imagenes/profesorIcono.png")));
