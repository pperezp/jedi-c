...
//            javax.swing.JOptionPane.showMessageDialog(null, "Error en llenado de combos SQL: "+e1.getMessage(), "Error", 0);
        }catch(Exception e2){
//            javax.swing.JOptionPane.showMessageDialog(null, e2.getMessage(), "Error", 0);
    ...
    public static int getIdentificadorSeccion(String nomtabla, String campoid, String camponom, String itemseleccionado){
        try{
            Conexion.sentencia = Conexion.con.createStatement();
            String buscar;
            int id;
