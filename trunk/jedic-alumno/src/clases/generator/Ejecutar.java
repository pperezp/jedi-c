...
public class Ejecutar {
    public static String nombreSO = System.getProperty("os.name");
    ...
    public static String ejecutarComandoGcc(String ruta, String rutaSinExtension){
        ...
        JedicAlumno.dialogCompilacion.setBounds(0, 0, 400, 100);
        JedicAlumno.dialogCompilacion.setLocationRelativeTo(null);
        JedicAlumno.textoDialogo.setText("Compilando...");
...
//                System.out.println(f.getName());
            ...
            resultado = error;
            System.out.println("Error al ejecutar: "+error);
