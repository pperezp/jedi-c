        ...
        try {
            ...
            if (Conexion.rs.next()) {
                ...
                if(Mail.enviarMail(email)){
                    ...
                    Historial.addHistorialGeneral("Un director solicitó la recuperación de su contraseña y "
                    + "se ha enviado un correo con la información. [director="+nom+", sede="+sede+", email="+email+"]");
                    Thread.sleep(1000);
                }else{
                ...
                Historial.addHistorialGeneral("Un director solicitó la recuperación de "
