...
public class Fecha {
     ...
     * @return
     */
    public static String getNumeroDeMes(){
        fecha = Calendar.getInstance();
        return Hora.cambiar(fecha.get(Calendar.MONTH)+1);
    }
    ...
    public static String getDia(){
        construirFecha();
        return Hora.cambiar(fecha.get(Calendar.DAY_OF_MONTH));
    }
...
//    }
     ...
     * @return
     */
    public static String getNombreDeMes(int mesEnNumeros){
        switch(mesEnNumeros){
            case 1:
                return "Enero";
            case 2:
