...
public class Reporte {
    ...
    public static void generarGraficoHTML(List listaObjetos, String nombreArchivoJasper, String nombreReporteHTML, Map parametros){
        try {
            JasperReport reporte = (JasperReport)JRLoader.loadObject(nombreArchivoJasper);
            JasperPrint jasperPrint = JasperFillManager.fillReport(reporte, parametros, new JRBeanCollectionDataSource(listaObjetos));
            JRExporter exporter = new JRHtmlExporter();
            exporter.setParameter(JRExporterParameter.JASPER_PRINT, jasperPrint);
            exporter.setParameter(JRExporterParameter.OUTPUT_FILE, new File(nombreReporteHTML));
            exporter.exportReport();
        } catch (JRException ex) {
            Logger.getLogger(Reporte.class.getName()).log(Level.SEVERE, null, ex);
        }
