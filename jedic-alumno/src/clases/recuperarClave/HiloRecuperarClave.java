...
import clases.utilidades.MensajeHilo;
...
public class HiloRecuperarClave extends Thread {
    ...
    private String nombreUsuarioDirector;
    ...
    public void setDatos(String consulta, String campoEmail, String campoNombre, String campoPass, String nombreEnte, String nombreUsuarioDirector){
        ...
        this.nombreUsuarioDirector = nombreUsuarioDirector;
    }
        ...
        try {
            ...
            if (Conexion.rs.next()) {
                ...
                if(Mail.enviarMail(email)){
                    ...
                    Historial.addHistorialGeneral("Un alumno solicitó la recuperación de su contraseña y "
                    + "se ha enviado un correo con la información. [alumno="+nom+", email="+email+"]");
                    Thread.sleep(1000);
                }else{
                ...
                Historial.addHistorialGeneral("Un alumno solicitó la recuperación de "
                        + "su contraseña pero ha ingresado mal su nombre de usuario. [user="+nombreUsuarioDirector+"]");
            }
